...
export default function JobReadyEstimate() {
  return (
    <div className="flex h-full flex-col justify-between rounded-2xl border border-white/5 bg-[#0a0c1a] p-6 shadow-xl relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h3 className="text-sm font-bold text-white leading-tight">Estimated Time to Become<br/>Job Ready</h3>
        </div>
        ...
        <p className="text-xs text-gray-400 mb-8">Consistency is the key!</p>
      </div>

      <button className="relative z-10 flex w-full items-center justify-center gap-2 rounded-lg bg-violet-600 py-3 text-xs font-bold text-white transition-all hover:bg-violet-500 hover:scale-[1.02] shadow-lg shadow-violet-500/25">
