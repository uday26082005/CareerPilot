...
export function ProfileSection() {
  return (
    <div className="flex items-center justify-between rounded-xl border border-white/5 bg-[#0a0c1a] p-6 shadow-sm">
      <div className="flex items-center gap-4">
        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-violet-700 text-2xl font-bold text-white">
          U
        </div>
        <div>
          <h2 className="text-lg font-bold text-white">Uday Kumar</h2>
...
export function AppearanceSettings() {
  return (
    <div className="flex flex-col rounded-xl border border-white/5 bg-[#0a0c1a] p-6 shadow-sm">
      <div className="flex items-center gap-3 mb-6">
        <Palette className="h-5 w-5 text-violet-400" />
        <div>
          <h3 className="text-sm font-bold text-white">Appearance</h3>
          <p className="text-[11px] text-gray-400">Customize how the application looks</p>
        </div>
      </div>
      <div className="flex-1 flex items-end">
        <div className="flex items-center justify-between w-full border-t border-white/5 pt-4">
          <div>
            ...
            <p className="text-[10px] text-gray-400">Enable dark theme</p>
          </div>
    ...
    <div className="flex flex-col rounded-xl border border-white/5 bg-[#0a0c1a] p-6 shadow-sm">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-[11px] text-gray-400">Manage your notifications</p>
        </div>
      </div>
      <div className="flex-1 flex items-end">
        <div className="flex items-center justify-between w-full border-t border-white/5 pt-4">
          <div>
            ...
            <p className="text-[10px] text-gray-400">Receive important updates and reminders</p>
          </div>
          <div className="relative inline-flex h-5 w-9 items-center rounded-full bg-violet-600">
            <span className="inline-block h-3 w-3 translate-x-5 transform rounded-full bg-white transition" />
          </div>
    ...
    <div className="flex flex-col rounded-xl border border-white/5 bg-[#0a0c1a] p-6 shadow-sm">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-[11px] text-gray-400">Language and regional preferences</p>
        </div>
      </div>
      <div className="flex-1 flex flex-col justify-end space-y-4 border-t border-white/5 pt-4">
        
        <div className="flex items-center justify-between w-full">
          <h4 className="text-xs font-bold text-white">Language</h4>
          <select className="w-40 bg-[#0a0c1a] border border-white/10 rounded-md px-3 py-1.5 text-xs text-gray-300 focus:outline-none focus:border-violet-500">
            <option>English</option>
          </select>
        </div>

        <div className="flex items-center justify-between w-full">
          <h4 className="text-xs font-bold text-white">Time Zone</h4>
          <select className="w-40 bg-[#0a0c1a] border border-white/10 rounded-md px-3 py-1.5 text-xs text-gray-300 focus:outline-none focus:border-violet-500">
      ...
      <div className="flex-1 flex items-end">
        <div className="flex items-center justify-between w-full border-t border-white/5 pt-4">
          <div>
            ...
            <p className="text-[10px] text-gray-400">Update your password regularly</p>
          </div>
    ...
    <div className="flex flex-col rounded-xl border border-white/5 bg-[#0a0c1a] p-6 shadow-sm">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-[11px] text-gray-400">Manage your data and privacy</p>
        </div>
      </div>
      <div className="flex items-center justify-between w-full border-t border-white/5 pt-4">
        <div>
          <h4 className="text-xs font-bold text-white">Download My Data</h4>
          <p className="text-[10px] text-gray-400">Download your account data and reports</p>
        </div>
    ...
    <div className="flex flex-col rounded-xl border border-white/5 bg-[#0a0c1a] p-6 shadow-sm">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-[11px] text-gray-400">Manage your account</p>
        </div>
      </div>
      <div className="flex items-center justify-between w-full border-t border-white/5 pt-4">
        <div>
          <h4 className="text-xs font-bold text-white">Logout</h4>
          <p className="text-[10px] text-gray-400">Sign out from AskAI</p>
        </div>
