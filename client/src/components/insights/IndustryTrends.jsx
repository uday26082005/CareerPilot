  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-white/5 bg-white/[0.02] p-6 backdrop-blur-md">
      ...
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-[11px] font-semibold text-gray-400">Industry Trends</h3>
      ...
      <div className="flex-1 flex flex-col justify-between">
        {TRENDS.map((trend, idx) => (
          <div key={idx} className="flex items-center justify-between gap-4 py-2 border-b border-white/5 last:border-0 last:pb-0 first:pt-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-[11px] font-bold text-white mb-0.5">{trend.name}</h4>
