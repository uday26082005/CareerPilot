  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-white/5 bg-white/[0.02] p-6 backdrop-blur-md relative overflow-hidden">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-[11px] font-semibold text-white">AI Career Advisor</h3>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center md:items-start flex-1">
        ...
        <div className="flex-1 flex flex-col justify-between h-full">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="rounded-xl border border-white/5 bg-[#0a0c1a] p-3 flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[9px] text-gray-500">Focus Area</span>
              </div>
              <span className="text-[10px] font-bold text-white leading-tight">Backend Development<br/>& Cloud</span>
            </div>
            ...
            <div className="rounded-xl border border-white/5 bg-[#0a0c1a] p-3 flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[9px] text-gray-500">Recommended Time</span>
              </div>
              <span className="text-[10px] font-bold text-white">4 Weeks</span>
            </div>
            ...
            <div className="rounded-xl border border-white/5 bg-[#0a0c1a] p-3 flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[9px] text-gray-500">Potential Improvement</span>
              </div>
