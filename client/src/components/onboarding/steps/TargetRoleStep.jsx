    ...
    >
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-xs font-semibold text-slate-900 dark:text-white">What role are you targeting?</label>
        ...
        {/* Preferred Industry */}
        <div className="space-y-2">
          <label className="text-xs font-semibold text-slate-900 dark:text-white">Preferred Industry (Optional)</label>
          <div className="relative flex items-center">
            <div className="absolute left-4 flex items-center justify-center">
        ...
        {/* Employment Type */}
        <div className="space-y-2">
          <label className="text-xs font-semibold text-slate-900 dark:text-white">Employment Type (Optional)</label>
          <div className="relative flex items-center">
            <div className="absolute left-4 flex items-center justify-center">
              <Briefcase className="h-4 w-4 text-violet-400" />
            </div>
        ...
        {/* Location Preference */}
        <div className="space-y-2">
          <label className="text-xs font-semibold text-slate-900 dark:text-white">Location Preference (Optional)</label>
          <div className="relative flex items-center">
            <div className="absolute left-4 flex items-center justify-center">
        ...
        {/* Info Banner */}
        <div className="mt-4 rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-white/[0.02] p-4 flex gap-4 items-start">
