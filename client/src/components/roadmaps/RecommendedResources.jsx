...
export default function RecommendedResources() {
  const RESOURCES = [
    ...
    { title: "Full Stack Projects Ideas", src: "Blog", type: "Article", icon: FileText, iconColor: "text-white bg-white/10" },
  ];

  return (
    <div className="flex flex-col rounded-2xl border border-white/5 bg-[#0a0c1a] p-5 shadow-lg">
      <div className="flex items-center justify-between mb-5">
        <h3 className="text-[11px] font-bold text-gray-300">Recommended Resources</h3>
          ...
          <div key={idx} className="flex items-center justify-between gap-3 rounded-xl border border-white/5 bg-white/[0.01] p-3 hover:bg-white/[0.03] transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[9px] text-gray-500">{item.src}</p>
              </div>
            </div>
