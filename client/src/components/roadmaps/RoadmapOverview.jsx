...
export default function RoadmapOverview() {
  ...
  return (
    <div className="flex rounded-2xl border border-white/5 bg-white/[0.02] p-6 backdrop-blur-md overflow-hidden relative">
        ...
        <div className="flex items-center justify-between md:pr-8">
          <div className="flex flex-col">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-0.5">Target Role</p>
                <h2 className="text-sm font-bold text-white">Full Stack Developer</h2>
              </div>
            </div>
            <div>
              <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-0.5">Experience Level</p>
          ...
          <div className="relative flex h-24 w-24 shrink-0 items-center justify-center ml-4">
            ...
            <div className="absolute flex flex-col items-center justify-center text-center">
              <span className="text-xl font-black text-white">{percentComplete}%</span>
        ...
        <div className="flex flex-col justify-center px-0 md:px-8 py-4 md:py-0 space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-gray-300">Completed</span>
            </div>
            <span className="text-xs font-bold text-white">12 / 45</span>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <CircleDashed className="h-4 w-4 text-blue-500" />
              <span className="text-xs font-medium text-gray-300">In Progress</span>
            </div>
            <span className="text-xs font-bold text-white">5 / 45</span>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-white">28 / 45</span>
          </div>
        </div>

        {/* Col 3: Estimated Time */}
        <div className="flex flex-col justify-center pl-0 md:pl-8">
          <p className="text-[10px] font-semibold text-gray-400 mb-2">Estimated Time to Complete</p>
