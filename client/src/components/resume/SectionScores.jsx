...
const SECTIONS = [
  ...
  { name: "Certifications", score: 95, icon: Award, color: "bg-pink-500", iconColor: "text-pink-400" },
          ...
          <div key={idx} className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <div className="mb-1.5 flex justify-between">
                ...
                <span className="text-sm font-bold text-slate-500 dark:text-gray-400">{section.score}/100</span>
              </div>
