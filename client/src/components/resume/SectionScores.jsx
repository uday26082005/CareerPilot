...
export default function SectionScores() {
  return (
    <div className="flex h-full flex-col rounded-2xl border border-white/5 bg-white/[0.02] p-6 backdrop-blur-md">
      <h3 className="mb-6 text-sm font-semibold text-gray-400">Section Scores</h3>
      
      <div className="flex flex-col gap-5">
        {SECTIONS.map((section, idx) => (
          <div key={idx} className="flex items-center gap-4">
            {/* Icon */}
            <div className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white/5 ${section.iconColor}`}>
            ...
            <div className="flex-1">
              <div className="mb-1.5 flex justify-between">
                ...
                <span className="text-xs font-bold text-gray-400">{section.score}/100</span>
              </div>
