...
export default function HeroBanner() {
  return (
    <div className="relative flex h-full flex-col justify-center overflow-hidden rounded-2xl border border-white/5 bg-[#0a0c1a] p-8 shadow-xl">
      ...
      <div className="relative z-10 flex h-full flex-col justify-between md:flex-row md:items-center">
        ...
        <div className="max-w-md">
          ...
          <button className="flex items-center gap-2 rounded-lg bg-violet-600 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-violet-500 shadow-lg shadow-violet-500/25">
        ...
        <div className="relative mt-8 flex shrink-0 items-center justify-center md:mt-0">
          ...
          <motion.div 
            ...
            className="absolute -right-8 -top-4 flex h-10 w-12 items-center justify-center rounded-xl rounded-bl-sm bg-[#1e2343] border border-white/10 shadow-xl"
          >
