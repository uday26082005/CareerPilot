...
export default function InterviewProgress() {
  return (
    <div className="flex h-full flex-col rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-white/[0.02] p-6 backdrop-blur-md">
      <h3 className="mb-4 text-sm font-semibold text-slate-500 dark:text-gray-400">Your Interview Progress</h3>
      
      <div className="grid grid-cols-2 gap-4 flex-1">
        {/* Card 1 */}
        <div className="flex items-center gap-3 rounded-xl border border-slate-200 dark:border-white/5 bg-white dark:bg-[#0a0c1a] p-3 transition-colors hover:bg-white/[0.04]">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-violet-500/10 text-violet-400">
            <Users className="h-5 w-5" />
          </div>
          <div>
            <p className="text-[10px] font-semibold text-slate-500 dark:text-gray-400">Interviews Taken</p>
        ...
        <div className="flex items-center gap-3 rounded-xl border border-slate-200 dark:border-white/5 bg-white dark:bg-[#0a0c1a] p-3 transition-colors hover:bg-white/[0.04]">
          ...
          <div>
            <p className="text-[10px] font-semibold text-slate-500 dark:text-gray-400">Avg. Score</p>
        ...
        <div className="flex items-center gap-3 rounded-xl border border-slate-200 dark:border-white/5 bg-white dark:bg-[#0a0c1a] p-3 transition-colors hover:bg-white/[0.04]">
          ...
          <div>
            <p className="text-[10px] font-semibold text-slate-500 dark:text-gray-400">Strong Areas</p>
        ...
        <div className="flex items-center gap-3 rounded-xl border border-slate-200 dark:border-white/5 bg-white dark:bg-[#0a0c1a] p-3 transition-colors hover:bg-white/[0.04]">
          ...
          <div>
            <p className="text-[10px] font-semibold text-slate-500 dark:text-gray-400">Areas to Improve</p>
