...
export default function Leaderboard() {
  return (
    <div className="flex flex-col gap-6 pb-6 w-full max-w-6xl mx-auto">
      ...
      {/* Tabs */}
      <div className="flex items-center gap-8 border-b border-slate-200 dark:border-white/10 pb-4">
        ...
        <button className="text-sm font-medium text-slate-400 dark:text-gray-500 hover:text-slate-600 dark:text-gray-300 transition-colors">
          This Week
        </button>
        <button className="text-sm font-medium text-slate-400 dark:text-gray-500 hover:text-slate-600 dark:text-gray-300 transition-colors">
          This Month
      ...
      {/* Footer Info */}
      <div className="mt-4 flex items-center gap-2 text-xs text-slate-400 dark:text-gray-500">
